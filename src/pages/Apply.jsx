...
import V from "../pages/home_sections/900cc44fae9f46c680a99105fabe5b096aa0144d.mp4";
...
const ApplyForm = () => {
  ...
  return (
    <div>
      <div className="video-div applyy">
            ...
            <form onSubmit={handleSubmit} className="apply-form">
              {step === 1 && (
                <div className="form-div">
                  <h2 className="industry">{t("Şirkət haqqında məlumat")}</h2>
              ...
              {step === 2 && (
                <div className="form-div">
                  <h2 className="industry">
                    {t("Ownership & Legal structure")}
                  </h2>
                  <label>
                    {t("Company type(LLC, JSC, Individual Entrepreneur, etc.)")}
                  </label>
                  <input
                    type="text"
                    name="companyName"
                  ...
                  <div>
                    <h2 className="industry">
                      {t("Industry & Business operations")}
                    </h2>
                    ...
                    >
                      ...
                      <option value="IT">
                        {t("Refined petroleum products")}
                      </option>
                      <option value="Manufacturing">{t("Chemicals")}</option>
                      <option value="Finance">
                        {t("Other non-metallic mineral products")}
                      </option>
              ...
              {step === 3 && (
                <div className="form-div">
                  ...
                  >
                    <div>
                      <label className="annual-label">
                        {t("Number of full-time employees")}
                      </label>
                      <select
                  ...
                  <h2 className="industry">
                    {t("Digital Readiness & Transformation Needs")}
                  </h2>
                  ...
                  >
                    <div>
                      ...
                      >
                        <option value="">{t("")}</option>
                        <option value="1">
                          {t("1 = No digital tool used")}
                        </option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
                        <option value="5">
                          {t("5 = Fully digital & automated processes")}
                        </option>
                      </select>
                    </div>
                  ...
                  <label>
                    {t(
                      "What are your company’s main digital transformation goals? (Short answer)"
                    )}
                  </label>
                  <input
                    type="text"
              ...
              {step === 4 && (
                <div className="form-div">
                  ...
                  <label>
                    {t(
                      "Does your company have dedicated digital transformation leader or team?(Yes/No)"
                    )}
                  </label>
                  <label>
                    <input
                  ...
                  <label>
                    {t(
                      "Has your company previously developed a digital transformation strategy or roadmap?(Yes/No)"
                    )}
                  </label>
                  <label>
                    <input
                  ...
                  <label>
                    {t(
                      "Are senior executives committed to implementing digital transformation strategy?(Yes/No)"
                    )}
                  </label>
                  <label>
                    <input
                  ...
                  <div>
                    <h2 className="industry">
                      {t("Funding & Financial support needs")}
                    </h2>
                    <label>
                      {t(
                        "Would your company require financial assistance for implementation?"
                      )}
                    </label>
                    <label>
                      <input
              ...
              {step === 5 && (
                <div className="form-div">
                  <h2 className="industry">
                    {t("Additional Supporting Document")}
                  </h2>
                  <form onSubmit={handleSubmit}>
                    ...
                    <div>
                      <label>
                        {t(
                          "Existing Digital Transformation Plans (if available):"
                        )}
                      </label>
                      <div>
                        <label
                    ...
                    <div>
                      <label className="confirm-text">
                        ...
                        />
                        {t(
                          "I agree to be contacted by 4SIM regarding my application."
                        )}
                      </label>
                    </div>
                  </form>
