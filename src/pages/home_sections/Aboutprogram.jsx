    ...
    <div className="about-program-main-container" id="abouttt">
      <div className="about-first-div">
        ...
        <p>
          ...
          which oversees the program's coordination and excetuion.
        </p>
        <p style={{ color: "#3484e5" }}>
          The program is implemented under the supervision of the Ministry of
          Economy of Azerbaijan(MoE), serving as the project sponsor.
        </p>
        <p>
          Aligned with the 2022-2026 Socio-Economic Development Strategy,{" "}
          <b>
        ...
        <p>
          Through structed assessments, stragic roadmaps, financial assistance,
          and ongoing mentorship,{" "}
          <b>
            The Digital Transformation Support Program equips businesses with
            the tools needed to thrive in the digital era.
          </b>
        </p>
      </div>
